...
- aliases
  - alternate names for tasks
  - useful for short forms and migration from older repo commands
- default task behavior
  - explicit default task when `fkn` is run with no task name
...
- improved importer coverage
  ...
  - better `package.json` argument inference
